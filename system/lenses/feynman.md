...
- 2026-07 | 기술 면접 대비에서 개념 복습의 기본 루프로 사용: 구현 전 결과를 등록하고
  실행 후 대조 (GQA·마스킹 등) | 예측 등록이 빠지면 복습이 열람으로 퇴화함을 확인
- 2026-08-17 | 그럴듯한 설명의 생성 비용이 0에 수렴한 환경에서는 재유도만이 이해의
  신호라는 판정에 사용 | "설명 가능 = 이해"의 반례 정리
